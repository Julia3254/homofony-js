...
function changeGrammar(word) {
    ...
    if (!vowelsArray.includes("i̯"))
        vowelsArray.push("i̯");
    if (!voicedArray.includes("i̯"))
        voicedArray.push("i̯");
    if (!softArray.includes("i̯"))
        softArray.push("i̯");
    //! dodatkowe akcenty
    ...
    if (word.includes("χ")) {
        ...
        if (word.startsWith("χi"))
            word = word.replace("χi", "χ́j");
    ...
    softArray.some((soft) => {
        if (word.startsWith("k"))
            word = word.replace("k" + soft, "ḱ" + soft);
    ...
    vowelsArray.some((vowel) => {
        ...
        if (word.endsWith(vowel + "ž"))
            word = word.replace(/ž$/, "š");
        if (vowel !== "i̯") {
            if (word.endsWith(vowel + "i"))
                word = word.replace(/i$/, "i̯i");
        }
        if (vowel !== "i" && vowel !== "i̯") {
    ...
    // anglicyzmy
    if (word.startsWith("vee"))
        word = word.replace("v", "u̯");
